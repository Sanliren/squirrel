package cn.thirdpart.squirrel.appreg.config.email;
...
public class MailUtil {
     ...
     */
    public void sendSimpleTextMail(String from, String subject,String content,String[] toWho,String[] ccPeoples,String[] bccPeoples,String[] attachments){
        ...
        if(attachments != null&&attachments.length > 0){
            try{
                ...
                boolean continueProcess = handleBasicInfo(from,helper,subject,content,toWho,ccPeoples,bccPeoples,false);
                //如果处理基本信息出现错误
                if(!continueProcess){
            ...
            //设置邮件的基本信息
            handleBasicInfo(from, simpleMailMessage,subject,content,toWho,ccPeoples,bccPeoples);
            //发送邮件
     ...
     */
    private boolean handleBasicInfo(String from, MimeMessageHelper mimeMessageHelper,String subject,String content,String[] toWho,String[] ccPeoples,String[] bccPeoples,boolean isHtml){
     ...
     * @param bccPeoples：暗送人
     */
    private void handleBasicInfo(String from, SimpleMailMessage simpleMailMessage,String subject,String content,String[] toWho,String[] ccPeoples,String[] bccPeoples){
        //设置发件人
     ...
     */
    public void sendHtmlTemplateMail(String from, String subject,String[] toWho,String[] ccPeoples,String[] bccPeoples,String[] attachments,String templateName,Context context,Set<ImageResource> imageResourceSet){
        ...
        try{
            ...
            //处理基本信息
            boolean continueProcess = handleBasicInfo(from, helper,subject,content,toWho,ccPeoples,bccPeoples,true);
            if(!continueProcess){
                logger.error("邮件基本信息出错：主题->{}",subject);
                return;
            }
